...
public class UTLParser extends Parser {
	...
	public static class AccessListContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof UTLListener ) ((UTLListener)listener).enterAccessList(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof UTLListener ) ((UTLListener)listener).exitAccessList(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof UTLVisitor ) return ((UTLVisitor<? extends T>)visitor).visitAccessList(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class ExpressionContext extends ParserRuleContext {
		...
		public List<TerminalNode> IS_NOT() { return getTokens(UTLParser.IS_NOT); }
		public TerminalNode IS_NOT(int i) {
			return getToken(UTLParser.IS_NOT, i);
		}
		public List<TerminalNode> IS() { return getTokens(UTLParser.IS); }
		public TerminalNode IS(int i) {
			return getToken(UTLParser.IS, i);
		}
